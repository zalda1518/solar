...
let Cuerpo = document.getElementById('sun').addEventListener("click", () => {
  ...
  let stopAudio = document.getElementById('silenciar').addEventListener("click", () => {
    audio.pause();
  })
});
...
var mercurio = document.getElementById('mercurio').addEventListener('click', merf);
...
function venf() {
  ...
  window.open('https://zalda1518.github.io/webnomina/');
}
...
function marf() {
  ...
  window.open('https://zalda1518.github.io/calculator/');
}

var jupiter = document.getElementById('jupiter').addEventListener('click', jupf);
...
var saturno = document.getElementById('saturno').addEventListener('click', satf);

function satf() {

  window.open('https://es.wikipedia.org/wiki/Saturno_(planeta)');
}
...
var neptuno = document.getElementById('neptuno').addEventListener('click', nepf);
